  ...
  <header>
    <div class="d-flex flex-column flex-md-row align-items-center pb-3 mb-4 border-bottom">
      ...
      <nav class="d-inline-flex mt-2 mt-md-0 ms-md-auto">
        <a class="me-3 py-2 text-dark text-decoration-none" href="#">Características</a>
        <a class="me-3 py-2 text-dark text-decoration-none" href="#">Empresa</a>
        <a class="me-3 py-2 text-dark text-decoration-none" href="#">Apoio</a>
        <a class="py-2 text-dark text-decoration-none" href="#">Preços</a>
      </nav>
    </div>

    <div class="pricing-header p-3 pb-md-4 mx-auto text-center">
      <h1 class="display-4 fw-normal">Olá, <b><?php echo htmlspecialchars($_SESSION["username"]); ?></b>. Bem vindo ao nosso site.</h1>
        <p>
      ...
      <div class="col">
        <div class="card mb-4 rounded-3 shadow-sm">
          ...
          <div class="card-body">
            ...
            <button type="button" class="w-100 btn btn-lg btn-primary">Começar</button>
          </div>
        </div>
      </div>
      <div class="col">
    ...
    <div class="row">
      ...
      <div class="col-6 col-md">
        ...
        <ul class="list-unstyled text-small">
          ...
          <li class="mb-1"><a class="link-secondary text-decoration-none" href="#">recurso Aleatório</a></li>
          <li class="mb-1"><a class="link-secondary text-decoration-none" href="#">recurso da equipe</a></li>
          <li class="mb-1"><a class="link-secondary text-decoration-none" href="#">Material para desenvolvedores</a></li>
          <li class="mb-1"><a class="link-secondary text-decoration-none" href="#">Outra</a></li>
          <li class="mb-1"><a class="link-secondary text-decoration-none" href="#">Última hora</a></li>
        </ul>
      </div>
      <div class="col-6 col-md">
        <h5>Resources</h5>
        <ul class="list-unstyled text-small">
          ...
          <li class="mb-1"><a class="link-secondary text-decoration-none" href="#">último recurso</a></li>
        </ul>
      </div>
      <div class="col-6 col-md">
        <h5>About</h5>
        <ul class="list-unstyled text-small">
          ...
          <li class="mb-1"><a class="link-secondary text-decoration-none" href="#">Locais</a></li>
